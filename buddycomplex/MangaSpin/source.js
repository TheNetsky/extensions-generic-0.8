...
var _Sources = (() => {
  ...
  // src/MangaSpin/MangaSpin.ts
  var MangaSpin_exports = {};
  __export(MangaSpin_exports, {
    MangaSpin: () => MangaSpin,
    MangaSpinInfo: () => MangaSpinInfo
  });
...
Please go to Settings > Sources > ${this.baseUrl} and press Cloudflare Bypass`);
  ...
  // src/MangaSpin/MangaSpin.ts
  var DOMAIN = "https://mangaspin.com";
  var MangaSpinInfo = {
  ...
  var MangaSpin = class extends BuddyComplex {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
    }
  };
  return __toCommonJS(MangaSpin_exports);
})();
