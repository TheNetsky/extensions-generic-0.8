...
var _Sources = (() => {
  ...
  // src/MangaFab/MangaFab.ts
  var MangaFab_exports = {};
  __export(MangaFab_exports, {
    MangaFab: () => MangaFab,
    MangaFabInfo: () => MangaFabInfo
  });
...
Please go to Settings > Sources > ${this.baseUrl} and press Cloudflare Bypass`);
  ...
  var MangaFab = class extends BuddyComplex {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
    }
  };
  return __toCommonJS(MangaFab_exports);
})();
