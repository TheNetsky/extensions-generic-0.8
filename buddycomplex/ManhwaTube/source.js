...
var _Sources = (() => {
  ...
  // src/ManhwaTube/ManhwaTube.ts
  var ManhwaTube_exports = {};
  __export(ManhwaTube_exports, {
    ManhwaTube: () => ManhwaTube,
    ManhwaTubeInfo: () => ManhwaTubeInfo
  });
...
Please go to Settings > Sources > ${this.baseUrl} and press Cloudflare Bypass`);
  ...
  // src/ManhwaTube/ManhwaTube.ts
  var DOMAIN = "https://manhwatube.com";
  var ManhwaTubeInfo = {
  ...
  var ManhwaTube = class extends BuddyComplex {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
    }
  };
  return __toCommonJS(ManhwaTube_exports);
})();
