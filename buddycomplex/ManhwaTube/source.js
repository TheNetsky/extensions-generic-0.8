...
class ManhwaTube extends BuddyComplex_1.BuddyComplex {
    constructor() {
        super(...arguments);
        this.baseUrl = DOMAIN;
    }
}
exports.ManhwaTube = ManhwaTube;
