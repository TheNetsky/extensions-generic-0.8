...
var _Sources = (() => {
  ...
  // src/ManhuaSite/ManhuaSite.ts
  var ManhuaSite_exports = {};
  __export(ManhuaSite_exports, {
    ManhuaSite: () => ManhuaSite,
    ManhuaSiteInfo: () => ManhuaSiteInfo
  });
...
Please go to Settings > Sources > ${this.baseUrl} and press Cloudflare Bypass`);
  ...
  // src/ManhuaSite/ManhuaSite.ts
  var DOMAIN = "https://manhuasite.com";
  var ManhuaSiteInfo = {
  ...
  var ManhuaSite = class extends BuddyComplex {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
    }
  };
  return __toCommonJS(ManhuaSite_exports);
})();
