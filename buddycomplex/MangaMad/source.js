...
var _Sources = (() => {
  ...
  // src/MangaMad/MangaMad.ts
  var MangaMad_exports = {};
  __export(MangaMad_exports, {
    MangaMad: () => MangaMad,
    MangaMadInfo: () => MangaMadInfo
  });
...
Please go to Settings > Sources > ${this.baseUrl} and press Cloudflare Bypass`);
  ...
  var MangaMad = class extends BuddyComplex {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
    }
  };
  return __toCommonJS(MangaMad_exports);
})();
