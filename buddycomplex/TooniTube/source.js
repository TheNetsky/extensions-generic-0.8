...
var _Sources = (() => {
  ...
  // src/TooniTube/TooniTube.ts
  var TooniTube_exports = {};
  __export(TooniTube_exports, {
    TooniTube: () => TooniTube,
    TooniTubeInfo: () => TooniTubeInfo
  });
...
Please go to Settings > Sources > ${this.baseUrl} and press Cloudflare Bypass`);
  ...
  // src/TooniTube/TooniTube.ts
  var DOMAIN = "https://toonitube.com";
  var TooniTubeInfo = {
  ...
  var TooniTube = class extends BuddyComplex {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
    }
  };
  return __toCommonJS(TooniTube_exports);
})();
