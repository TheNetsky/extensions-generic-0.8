...
var _Sources = (() => {
  ...
  // src/MangaSaga/MangaSaga.ts
  var MangaSaga_exports = {};
  __export(MangaSaga_exports, {
    MangaSaga: () => MangaSaga,
    MangaSagaInfo: () => MangaSagaInfo
  });
...
Please go to Settings > Sources > ${this.baseUrl} and press Cloudflare Bypass`);
  ...
  // src/MangaSaga/MangaSaga.ts
  var DOMAIN = "https://mangasaga.com";
  var MangaSagaInfo = {
  ...
  var MangaSaga = class extends BuddyComplex {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
    }
  };
  return __toCommonJS(MangaSaga_exports);
})();
