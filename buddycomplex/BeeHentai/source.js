...
var _Sources = (() => {
  ...
  // src/BeeHentai/BeeHentai.ts
  var BeeHentai_exports = {};
  __export(BeeHentai_exports, {
    BeeHentai: () => BeeHentai,
    BeeHentaiInfo: () => BeeHentaiInfo
  });
...
Please go to Settings > Sources > ${this.baseUrl} and press Cloudflare Bypass`);
  ...
  // src/BeeHentai/BeeHentai.ts
  var DOMAIN = "https://beehentai.com";
  var BeeHentaiInfo = {
  ...
  var BeeHentai = class extends BuddyComplex {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
    }
  };
  return __toCommonJS(BeeHentai_exports);
})();
