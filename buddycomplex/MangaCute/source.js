...
var _Sources = (() => {
  ...
  // src/MangaCute/MangaCute.ts
  var MangaCute_exports = {};
  __export(MangaCute_exports, {
    MangaCute: () => MangaCute,
    MangaCuteInfo: () => MangaCuteInfo
  });
...
Please go to Settings > Sources > ${this.baseUrl} and press Cloudflare Bypass`);
  ...
  // src/MangaCute/MangaCute.ts
  var DOMAIN = "https://mangacute.com";
  var MangaCuteInfo = {
  ...
  var MangaCute = class extends BuddyComplex {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
    }
  };
  return __toCommonJS(MangaCute_exports);
})();
