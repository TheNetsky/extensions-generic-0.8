...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.MangaCute = exports.MangaCuteInfo = void 0;
const types_1 = require("@paperback/types");
const BuddyComplex_1 = require("../BuddyComplex");
const DOMAIN = 'https://mangacute.com';
exports.MangaCuteInfo = {
...
class MangaCute extends BuddyComplex_1.BuddyComplex {
    constructor() {
        super(...arguments);
        this.baseUrl = DOMAIN;
    }
}
exports.MangaCute = MangaCute;
