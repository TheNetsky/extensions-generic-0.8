...
var _Sources = (() => {
  ...
  // src/MangaXYZ/MangaXYZ.ts
  var MangaXYZ_exports = {};
  __export(MangaXYZ_exports, {
    MangaXYZ: () => MangaXYZ,
    MangaXYZInfo: () => MangaXYZInfo
  });
...
Please go to Settings > Sources > ${this.baseUrl} and press Cloudflare Bypass`);
  ...
  var MangaXYZ = class extends BuddyComplex {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
    }
  };
  return __toCommonJS(MangaXYZ_exports);
})();
