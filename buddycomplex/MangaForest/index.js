...
class MangaForest extends BuddyComplex_1.BuddyComplex {
    constructor() {
        super(...arguments);
        this.baseUrl = DOMAIN;
    }
}
exports.MangaForest = MangaForest;
