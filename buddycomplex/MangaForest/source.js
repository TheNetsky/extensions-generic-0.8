...
var _Sources = (() => {
  ...
  // src/MangaForest/MangaForest.ts
  var MangaForest_exports = {};
  __export(MangaForest_exports, {
    MangaForest: () => MangaForest,
    MangaForestInfo: () => MangaForestInfo
  });
  ...
  var BuddyComplexParser = class {
    ...
    decodeHTMLEntity(str) {
      return (0, import_html_entities.decode)(str);
    }
    idCleaner(str) {
      let cleanId = str;
...
Please go to Settings > Sources > ${this.baseUrl} and press Cloudflare Bypass`);
  ...
  // src/MangaForest/MangaForest.ts
  var DOMAIN = "https://mangaforest.com";
  var MangaForestInfo = {
  ...
  var MangaForest = class extends BuddyComplex {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
    }
  };
  return __toCommonJS(MangaForest_exports);
})();
