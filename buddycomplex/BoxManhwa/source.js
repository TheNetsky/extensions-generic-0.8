...
var _Sources = (() => {
  ...
  // src/BoxManhwa/BoxManhwa.ts
  var BoxManhwa_exports = {};
  __export(BoxManhwa_exports, {
    BoxManhwa: () => BoxManhwa,
    BoxManhwaInfo: () => BoxManhwaInfo
  });
...
Please go to Settings > Sources > ${this.baseUrl} and press Cloudflare Bypass`);
  ...
  // src/BoxManhwa/BoxManhwa.ts
  var DOMAIN = "https://boxmanhwa.com";
  var BoxManhwaInfo = {
  ...
  var BoxManhwa = class extends BuddyComplex {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
    }
  };
  return __toCommonJS(BoxManhwa_exports);
})();
