...
var _Sources = (() => {
  ...
  // src/TrueManga/TrueManga.ts
  var TrueManga_exports = {};
  __export(TrueManga_exports, {
    TrueManga: () => TrueManga,
    TrueMangaInfo: () => TrueMangaInfo
  });
...
Please go to Settings > Sources > ${this.baseUrl} and press Cloudflare Bypass`);
  ...
  // src/TrueManga/TrueManga.ts
  var DOMAIN = "https://truemanga.com";
  var TrueMangaInfo = {
  ...
  var TrueManga = class extends BuddyComplex {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
    }
  };
  return __toCommonJS(TrueManga_exports);
})();
