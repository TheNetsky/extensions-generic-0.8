...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.Liliana = exports.getExportVersion = void 0;
const types_1 = require("@paperback/types");
const LilianaParser_1 = require("./LilianaParser");
const LilianaHelper_1 = require("./LilianaHelper");
    ...
    async constructSearchRequest(page, query) {
        if (query?.title) {
            ...
            urlBuilder = urlBuilder
                .addQueryParameter('genres', (0, LilianaHelper_1.getFilterTagsBySection)('genres', query?.includedTags, true))
                .addQueryParameter('notGenres', (0, LilianaHelper_1.getFilterTagsBySection)('genres', query?.excludedTags, true, await this.supportsTagExclusion()))
                .addQueryParameter('type', (0, LilianaHelper_1.getIncludedTagBySection)('type', query?.includedTags))
                .addQueryParameter('count', (0, LilianaHelper_1.getIncludedTagBySection)('count', query?.includedTags))
                .addQueryParameter('status', (0, LilianaHelper_1.getIncludedTagBySection)('status', query?.includedTags))
                .addQueryParameter('gender', (0, LilianaHelper_1.getIncludedTagBySection)('gender', query?.includedTags))
                .addQueryParameter('sort', (0, LilianaHelper_1.getIncludedTagBySection)('sort', query?.includedTags));
            return App.createRequest({
                url: decodeURI(urlBuilder.buildUrl({ addTrailingSlash: true, includeUndefinedParameters: false })),
                method: 'GET'
            });
...
exports.Liliana = Liliana;

},{"./LilianaHelper":71,"./LilianaParser":72,"@paperback/types":61}],71:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.URLBuilder = exports.getFilterTagsBySection = exports.getIncludedTagBySection = exports.createHomeSection = exports.DefaultHomeSectionData = void 0;
...
},{"@paperback/types":61}],72:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class Parser {
    ...
    parseHomeSection($, section, source) {
        const items = [];
    ...
    parseJSONSearchResults(data, source) {
        const results = [];
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.ManhuaPlusORG = exports.ManhuaPlusORGInfo = void 0;
const types_1 = require("@paperback/types");
const Liliana_1 = require("../Liliana");
const DOMAIN = 'https://manhuaplus.org';
exports.ManhuaPlusORGInfo = {
...
class ManhuaPlusORG extends Liliana_1.Liliana {
    constructor() {
        super(...arguments);
        this.baseUrl = DOMAIN;
    }
}
exports.ManhuaPlusORG = ManhuaPlusORG;

},{"../Liliana":70,"@paperback/types":61}]},{},[73])(73)
});
