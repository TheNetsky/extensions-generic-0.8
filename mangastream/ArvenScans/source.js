...
var _Sources = (() => {
  ...
  // src/ArvenScans/ArvenScans.ts
  var ArvenScans_exports = {};
  __export(ArvenScans_exports, {
    ArvenScans: () => ArvenScans,
    ArvenScansInfo: () => ArvenScansInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/ArvenScans/ArvenScans.ts
  var DOMAIN = "https://arvencomics.com";
  var ArvenScansInfo = {
  ...
  var ArvenScans = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(ArvenScans_exports);
})();
