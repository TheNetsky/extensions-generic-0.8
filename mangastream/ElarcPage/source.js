...
var _Sources = (() => {
  ...
  var ElarcPage_exports = {};
  __export(ElarcPage_exports, {
    ElarcPage: () => ElarcPage,
    ElarcPageInfo: () => ElarcPageInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  var ElarcPage = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(ElarcPage_exports);
})();
