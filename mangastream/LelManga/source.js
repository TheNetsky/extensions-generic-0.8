...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  var LelManga = class extends MangaStream {
    ...
    configureSections() {
      this.homescreen_sections["popular_today"].selectorFunc = ($2) => $2("div.bsx", $2("h2:contains(Top Managa Aujourd'hui)")?.parent()?.next());
      this.homescreen_sections["latest_update"].selectorFunc = ($2) => $2("div.uta", $2("h2:contains(Derni\xE8res Sorties)")?.parent()?.next());
