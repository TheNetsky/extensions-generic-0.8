...
},{"./named-references":63,"./numeric-unicode-map":64,"./surrogate-pairs":65}],63:[function(require,module,exports){
...
class LelManga extends MangaStream_1.MangaStream {
    ...
    configureSections() {
        this.homescreen_sections['popular_today'].selectorFunc = ($) => $('div.bsx', $('h2:contains(Top Managa Aujourd\'hui)')?.parent()?.next());
        this.homescreen_sections['latest_update'].selectorFunc = ($) => $('div.uta', $('h2:contains(Dernières Sorties)')?.parent()?.next());
        this.homescreen_sections['new_titles'].enabled = false;
    }
}
exports.LelManga = LelManga;

},{"../MangaStream":68,"@paperback/types":61}],68:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./MangaStreamHelper":69,"./MangaStreamParser":70,"./UrlBuilder":71,"@paperback/types":61}],69:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"@paperback/types":61}],70:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class MangaStreamParser {
    ...
    parseMangaDetails($, mangaId, source) {
        const titles = [];
        titles.push((0, html_entities_1.decode)($('h1.entry-title').text().trim()));
        ...
        for (const title of altTitles) {
            ...
            titles.push((0, html_entities_1.decode)(title.trim()));
        }
        ...
        const description = (0, html_entities_1.decode)($('div[itemprop="description"]  p').text().trim());
        const arrayTags = [];
    ...
    parseChapterList($, mangaId, source) {
        ...
        for (const chapter of $('li', 'div#chapterlist').toArray()) {
            const title = (0, html_entities_1.decode)($('span.chapternum', chapter).text().trim());
    ...
    parseChapterDetails($, mangaId, chapterId) {
        ...
        for (const index of scriptObj.sources) { // Check all sources, if empty continue.
            if (index?.images.length == 0)
                continue;
            index.images.map((p) => pages.push(encodeURI(p.trim())));
        }
    ...
    async parseSearchResults($, source) {
        ...
        for (const obj of $('div.bs', 'div.listupd').toArray()) {
            ...
            results.push({
                ...
                title: (0, html_entities_1.decode)(title),
                subtitle: (0, html_entities_1.decode)(subtitle)
            });
        }
        return results;
    }
    ...
    getImageSrc(imageObj) {
        ...
        image = image.replace(/^\//, 'https:/');
        return encodeURI(decodeURI((0, html_entities_1.decode)(image?.trim())));
    }
    idCleaner(str) {
        let cleanId = str;
...
},{"./LanguageUtils":66,"html-entities":62}],71:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
