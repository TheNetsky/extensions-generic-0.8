...
var _Sources = (() => {
  ...
  // src/RawKuma/RawKuma.ts
  var RawKuma_exports = {};
  __export(RawKuma_exports, {
    RawKuma: () => RawKuma,
    RawKumaInfo: () => RawKumaInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  var RawKuma = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
      this.language = "\u{1F1EF}\u{1F1F5}";
    }
    configureSections() {
      this.homescreen_sections["latest_update"].selectorFunc = ($) => $("div.uta", $("h3:contains(Latest Update)")?.parent()?.next());
    }
  };
  return __toCommonJS(RawKuma_exports);
})();
