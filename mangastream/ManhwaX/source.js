...
var _Sources = (() => {
  ...
  // src/ManhwaX/ManhwaX.ts
  var ManhwaX_exports = {};
  __export(ManhwaX_exports, {
    ManhwaX: () => ManhwaX,
    ManhwaXInfo: () => ManhwaXInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  var ManhwaX = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
    }
  ...
  return __toCommonJS(ManhwaX_exports);
})();
