...
var _Sources = (() => {
  ...
  // src/LuminousScans/LuminousScans.ts
  var LuminousScans_exports = {};
  __export(LuminousScans_exports, {
    LuminousScans: () => LuminousScans,
    LuminousScansInfo: () => LuminousScansInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/LuminousScans/LuminousScans.ts
  var DOMAIN = "https://radiantscans.com";
  var LuminousScansInfo = {
  ...
  var LuminousScans = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(LuminousScans_exports);
})();
