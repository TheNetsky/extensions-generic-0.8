...
var _Sources = (() => {
  ...
  // src/SushiScan/SushiScan.ts
  var SushiScan_exports = {};
  __export(SushiScan_exports, {
    SushiScan: () => SushiScan,
    SushiScanInfo: () => SushiScanInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/SushiScan/SushiScan.ts
  var DOMAIN = "https://sushiscan.net";
  var SushiScanInfo = {
  ...
  var SushiScan = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
    ...
    configureSections() {
      ...
      this.homescreen_sections["latest_update"].selectorFunc = ($) => $("div.utao", $("h2:contains(Derni\xE8res Sorties)")?.parent()?.next());
      this.homescreen_sections["new_titles"].enabled = false;
    }
  };
  return __toCommonJS(SushiScan_exports);
})();
