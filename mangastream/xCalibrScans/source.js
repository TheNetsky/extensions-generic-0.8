...
var _Sources = (() => {
  ...
  // src/xCalibrScans/xCalibrScans.ts
  var xCalibrScans_exports = {};
  __export(xCalibrScans_exports, {
    xCalibrScans: () => xCalibrScans,
    xCalibrScansInfo: () => xCalibrScansInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/xCalibrScans/xCalibrScans.ts
  var DOMAIN = "https://xcalibrscans.com";
  var xCalibrScansInfo = {
  ...
  var xCalibrScans = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
    }
  ...
  return __toCommonJS(xCalibrScans_exports);
})();
