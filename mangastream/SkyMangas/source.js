...
var _Sources = (() => {
  ...
  // src/SkyMangas/SkyMangas.ts
  var SkyMangas_exports = {};
  __export(SkyMangas_exports, {
    SkyMangas: () => SkyMangas,
    SkyMangasInfo: () => SkyMangasInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/SkyMangas/SkyMangasParser.ts
  var SkyMangasParser = class extends MangaStreamParser {
    parseChapterDetails($, mangaId, chapterId) {
      const pages = [];
      let obj;
  ...
  // src/SkyMangas/SkyMangas.ts
  var DOMAIN = "https://skymangas.com";
  var SkyMangasInfo = {
  ...
  var SkyMangas = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
      this.language = "\u{1F1EA}\u{1F1F8}";
      this.parser = new SkyMangasParser();
      //----DATE SETTINGS
      this.dateMonths = {
        january: "enero",
        february: "febrero",
  ...
  return __toCommonJS(SkyMangas_exports);
})();
