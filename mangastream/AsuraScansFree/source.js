...
var _Sources = (() => {
  ...
  // src/AsuraScansFree/AsuraScansFree.ts
  var AsuraScansFree_exports = {};
  __export(AsuraScansFree_exports, {
    AsuraScansFree: () => AsuraScansFree,
    AsuraScansFreeInfo: () => AsuraScansFreeInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/AsuraScansFree/AsuraScansFree.ts
  var DOMAIN = "https://asurascansfree.com";
  var AsuraScansFreeInfo = {
  ...
  var AsuraScansFree = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
    ...
    configureSections() {
      ...
      this.homescreen_sections["latest_update"].subtitleSelectorFunc = ($2, element) => $2(".fivchap", element).first().text().trim();
      this.homescreen_sections["new_titles"].selectorFunc = ($2) => $2("li", $2("h3:contains(Newest additions)")?.parent()?.next());
    }
  };
  return __toCommonJS(AsuraScansFree_exports);
})();
