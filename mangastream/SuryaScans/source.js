...
var _Sources = (() => {
  ...
  // src/SuryaScans/SuryaScans.ts
  var SuryaScans_exports = {};
  __export(SuryaScans_exports, {
    SuryaScans: () => SuryaScans,
    SuryaScansInfo: () => SuryaScansInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/SuryaScans/SuryaScans.ts
  var DOMAIN = "https://genztoons.com";
  var SuryaScansInfo = {
  ...
  var SuryaScans = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
    }
  ...
  return __toCommonJS(SuryaScans_exports);
})();
