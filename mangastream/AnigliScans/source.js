...
var _Sources = (() => {
  ...
  // src/AnigliScans/AnigliScans.ts
  var AnigliScans_exports = {};
  __export(AnigliScans_exports, {
    AnigliScans: () => AnigliScans,
    AnigliScansInfo: () => AnigliScansInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/AnigliScans/AnigliScans.ts
  var DOMAIN = "https://anigliscans.xyz";
  var AnigliScansInfo = {
  ...
  var AnigliScans = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(AnigliScans_exports);
})();
