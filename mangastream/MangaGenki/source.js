...
var _Sources = (() => {
  ...
  // src/MangaGenki/MangaGenki.ts
  var MangaGenki_exports = {};
  __export(MangaGenki_exports, {
    MangaGenki: () => MangaGenki,
    MangaGenkiInfo: () => MangaGenkiInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/MangaGenki/MangaGenki.ts
  var DOMAIN = "https://mangagenki.com";
  var MangaGenkiInfo = {
  ...
  var MangaGenki = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
    }
  ...
  return __toCommonJS(MangaGenki_exports);
})();
