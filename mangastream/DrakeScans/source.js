...
var _Sources = (() => {
  ...
  // src/DrakeScans/DrakeScans.ts
  var DrakeScans_exports = {};
  __export(DrakeScans_exports, {
    DrakeScans: () => DrakeScans,
    DrakeScansInfo: () => DrakeScansInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/DrakeScans/DrakeScans.ts
  var DOMAIN = "https://drakecomic.com";
  var DrakeScansInfo = {
  ...
  var DrakeScans = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
    }
  };
  return __toCommonJS(DrakeScans_exports);
})();
