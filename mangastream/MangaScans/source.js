...
var _Sources = (() => {
  ...
  // src/MangaScans/MangaScans.ts
  var MangaScans_exports = {};
  __export(MangaScans_exports, {
    MangaScans: () => MangaScans,
    MangaScansInfo: () => MangaScansInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/MangaScans/MangaScans.ts
  var DOMAIN = "https://mangascans.org";
  var MangaScansInfo = {
  ...
  var MangaScans = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
    }
  ...
  return __toCommonJS(MangaScans_exports);
})();
