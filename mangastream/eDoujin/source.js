...
var _Sources = (() => {
  ...
  // src/eDoujin/eDoujin.ts
  var eDoujin_exports = {};
  __export(eDoujin_exports, {
    eDoujin: () => eDoujin,
    eDoujinInfo: () => eDoujinInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/eDoujin/eDoujin.ts
  var DOMAIN = "https://ehentaimanga.com";
  var eDoujinInfo = {
  ...
  var eDoujin = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
    }
  ...
  return __toCommonJS(eDoujin_exports);
})();
