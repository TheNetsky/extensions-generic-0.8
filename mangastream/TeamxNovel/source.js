...
var _Sources = (() => {
  ...
  var TeamxNovel_exports = {};
  __export(TeamxNovel_exports, {
    TeamxNovel: () => TeamxNovel,
    TeamxNovelInfo: () => TeamxNovelInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  var TeamxNovel = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(TeamxNovel_exports);
})();
