...
var _Sources = (() => {
  ...
  // src/QuantumScans/QuantumScans.ts
  var QuantumScans_exports = {};
  __export(QuantumScans_exports, {
    QuantumScans: () => QuantumScans,
    QuantumScansInfo: () => QuantumScansInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/QuantumScans/QuantumScans.ts
  var DOMAIN = "https://qscomics.org";
  var QuantumScansInfo = {
  ...
  var QuantumScans = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(QuantumScans_exports);
})();
