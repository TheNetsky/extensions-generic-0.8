...
var _Sources = (() => {
  ...
  var FlameComics_exports = {};
  __export(FlameComics_exports, {
    FlameComics: () => FlameComics,
    FlameComicsInfo: () => FlameComicsInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/FlameComics/FlameComics.ts
  var DOMAIN = "https://flamecomics.xyz";
  var FlameComicsInfo = {
  ...
  var FlameComics = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
