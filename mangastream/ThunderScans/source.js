...
var _Sources = (() => {
  ...
  // src/ThunderScans/ThunderScans.ts
  var ThunderScans_exports = {};
  __export(ThunderScans_exports, {
    ThunderScans: () => ThunderScans,
    ThunderScansInfo: () => ThunderScansInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/ThunderScans/ThunderScans.ts
  var DOMAIN = "https://en-thunderscans.com";
  var ThunderScansInfo = {
  ...
  var ThunderScans = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(ThunderScans_exports);
})();
