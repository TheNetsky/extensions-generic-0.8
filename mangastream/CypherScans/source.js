...
var _Sources = (() => {
  ...
  var CypherScans_exports = {};
  __export(CypherScans_exports, {
    CypherScans: () => CypherScans,
    CypherScansInfo: () => CypherScansInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  var CypherScans = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
    }
  ...
  return __toCommonJS(CypherScans_exports);
})();
