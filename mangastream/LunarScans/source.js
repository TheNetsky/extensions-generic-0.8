...
var _Sources = (() => {
  ...
  // src/LunarScans/LunarScans.ts
  var LunarScans_exports = {};
  __export(LunarScans_exports, {
    LunarScans: () => LunarScans,
    LunarScansInfo: () => LunarScansInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/LunarScans/LunarScans.ts
  var DOMAIN = "https://lunarscan.org";
  var LunarScansInfo = {
  ...
  var LunarScans = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(LunarScans_exports);
})();
