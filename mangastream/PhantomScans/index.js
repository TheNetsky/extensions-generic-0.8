...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.PhantomScans = exports.PhantomScansInfo = void 0;
const types_1 = require("@paperback/types");
const MangaStream_1 = require("../MangaStream");
const DOMAIN = 'https://phantomscans.com';
exports.PhantomScansInfo = {
...
class PhantomScans extends MangaStream_1.MangaStream {
    constructor() {
        super(...arguments);
        this.baseUrl = DOMAIN;
    }
    configureSections() {
        ...
        this.homescreen_sections['latest_update'].selectorFunc = ($) => $('div.uta', $('h2:contains(Latest Update)')?.parent()?.next());
        this.homescreen_sections['latest_update'].subtitleSelectorFunc = ($, element) => $('div.luf > ul > li > a', element).first().text().trim();
    }
}
exports.PhantomScans = PhantomScans;
