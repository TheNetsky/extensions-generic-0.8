...
var _Sources = (() => {
  ...
  // src/Hentai20/Hentai20.ts
  var Hentai20_exports = {};
  __export(Hentai20_exports, {
    Hentai20: () => Hentai20,
    Hentai20Info: () => Hentai20Info
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  var Hentai20 = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(Hentai20_exports);
})();
