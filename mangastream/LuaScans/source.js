...
var _Sources = (() => {
  ...
  // src/LuaScans/LuaScans.ts
  var LuaScans_exports = {};
  __export(LuaScans_exports, {
    LuaScans: () => LuaScans,
    LuaScansInfo: () => LuaScansInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  var LuaScans = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
    }
  ...
  return __toCommonJS(LuaScans_exports);
})();
