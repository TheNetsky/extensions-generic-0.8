...
var _Sources = (() => {
  ...
  // src/ReadKomik/ReadKomik.ts
  var ReadKomik_exports = {};
  __export(ReadKomik_exports, {
    ReadKomik: () => ReadKomik,
    ReadKomikInfo: () => ReadKomikInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  var ReadKomik = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
    }
  ...
  return __toCommonJS(ReadKomik_exports);
})();
