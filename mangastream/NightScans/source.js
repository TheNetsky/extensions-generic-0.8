...
var _Sources = (() => {
  ...
  // src/NightScans/NightScans.ts
  var NightScans_exports = {};
  __export(NightScans_exports, {
    NightScans: () => NightScans,
    NightScansInfo: () => NightScansInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  var NightScans = class extends MangaStream {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
    }
  ...
  return __toCommonJS(NightScans_exports);
})();
