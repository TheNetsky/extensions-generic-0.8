...
import { NonStopScans } from '../NonStopScans/NonStopScans'
import chai from 'chai'
import chaiAsPromised from 'chai-as-promised'

describe('NonStopScans Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: MangaStream = new NonStopScans(cheerio)
   ...
   */
    const mangaId = 'the-strongest-god-king' // the-strongest-god-king
