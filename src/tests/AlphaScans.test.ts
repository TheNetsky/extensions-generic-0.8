...
import { AlphaScans } from '../AlphaScans/AlphaScans'
import chai from 'chai'
import chaiAsPromised from 'chai-as-promised'

describe('AlphaScans Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: MangaStream = new AlphaScans(cheerio)
   ...
   */
    const mangaId = 'supreme-taoist' // supreme-taoist
