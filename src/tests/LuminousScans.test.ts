...
import { LuminousScans } from '../LuminousScans/LuminousScans'
import chai from 'chai'
import chaiAsPromised from 'chai-as-promised'

describe('LuminousScans Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: MangaStream = new LuminousScans(cheerio)
   ...
   */
    const mangaId = '1653732347-wind-breaker' // 1653732347-wind-breaker
