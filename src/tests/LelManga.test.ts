...
import { LelManga } from '../LelManga/LelManga'
import chai from 'chai'
import chaiAsPromised from 'chai-as-promised'

describe('LelManga Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: MangaStream = new LelManga(cheerio)
   ...
   */
    const mangaId = 'tokyo-revengers' // tokyo-revengers
