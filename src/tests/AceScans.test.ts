...
import { AceScans } from '../AceScans/AceScans'
import chai from 'chai'
import chaiAsPromised from 'chai-as-promised'

describe('AceScans Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: MangaStream = new AceScans(cheerio)
   ...
   */
    const mangaId = 'next-door-kuroki-san-is-dangerous-when-she-drinks' // next-door-kuroki-san-is-dangerous-when-she-drinks
