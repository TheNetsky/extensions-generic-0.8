...
import { BlackArmy } from '../BlackArmy/BlackArmy'
import { APIWrapper } from "paperback-extensions-common";

describe('BlackArmy Tests', function () {

    var wrapper: APIWrapper = new APIWrapper();
    var source: MangaStream = new BlackArmy(cheerio);
     ...
     */
    var mangaId = "the-flower-dances-and-the-wind-sings";
    ...
    //New Titles
    it("Testing home page results for top new titles", async () => {
        let results = await wrapper.getViewMoreItems(source, "new_titles", {},);
