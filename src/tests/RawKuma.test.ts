...
import { RawKuma } from '../RawKuma/RawKuma'
import { APIWrapper } from "paperback-extensions-common";

describe('RawKuma Tests', function () {

    var wrapper: APIWrapper = new APIWrapper();
    var source: MangaStream = new RawKuma(cheerio);
     ...
     */
    var mangaId = "a-villainess-is-a-good-match-for-the-tyrant";
