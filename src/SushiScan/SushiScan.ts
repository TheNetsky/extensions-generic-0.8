...
export class SushiScan extends MangaStream {
    ...
    override configureSections() {
        this.homescreen_sections['popular_today'].selectorFunc = ($: CheerioAPI) => $('div.bsx', $('h2:contains(Populaire Aujourd\'hui)')?.parent()?.next())
        this.homescreen_sections['latest_update'].selectorFunc = ($: CheerioAPI) => $('div.utao', $('h2:contains(Dernières Sorties)')?.parent()?.next())
