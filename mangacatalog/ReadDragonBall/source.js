...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.ReadDragonBall = exports.ReadDragonBallInfo = void 0;
const types_1 = require("@paperback/types");
const MangaCatalog_1 = require("../MangaCatalog");
const DOMAIN = 'https://dbsmanga.com';
exports.ReadDragonBallInfo = {
...
class ReadDragonBall extends MangaCatalog_1.MangaCatalog {
    constructor() {
        super(...arguments);
        this.baseUrl = DOMAIN;
        this.iconUrl = 'https://i.imgur.com/xKpUtga.png';
        this.baseSourceList = [
            {
...
exports.ReadDragonBall = ReadDragonBall;
