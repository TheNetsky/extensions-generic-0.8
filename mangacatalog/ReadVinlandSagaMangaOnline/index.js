...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.ReadVinlandSagaMangaOnline = exports.ReadVinlandSagaMangaOnlineInfo = void 0;
const types_1 = require("@paperback/types");
const MangaCatalog_1 = require("../MangaCatalog");
const DOMAIN = 'https://ww2.readvinlandsaga.com';
exports.ReadVinlandSagaMangaOnlineInfo = {
    version: (0, MangaCatalog_1.getExportVersion)('0.0.0'),
    name: 'ReadVinlandSagaMangaOnline',
...
class ReadVinlandSagaMangaOnline extends MangaCatalog_1.MangaCatalog {
    constructor() {
        super(...arguments);
        this.baseUrl = DOMAIN;
        this.sourceUrlList = [
            DOMAIN + "/manga/vinland-saga/",
            DOMAIN + "/manga/vinland-saga-colored/",
            DOMAIN + "/manga/planetes/",
        ];
    }
}
exports.ReadVinlandSagaMangaOnline = ReadVinlandSagaMangaOnline;
