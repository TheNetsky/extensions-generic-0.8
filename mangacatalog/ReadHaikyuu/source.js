...
class ReadHaikyuu extends MangaCatalog_1.MangaCatalog {
    constructor() {
        super(...arguments);
        this.baseUrl = DOMAIN;
        this.iconUrl = 'https://i.imgur.com/w2ubpnd.png';
        this.baseSourceList = [
            {
...
exports.ReadHaikyuu = ReadHaikyuu;
