...
class ReadBleach extends MangaCatalog_1.MangaCatalog {
    constructor() {
        super(...arguments);
        this.baseUrl = DOMAIN;
        this.iconUrl = 'https://i.imgur.com/Vf65wQL.png';
        this.baseSourceList = [
            {
