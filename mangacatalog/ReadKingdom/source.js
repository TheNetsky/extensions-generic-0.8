...
class ReadKingdom extends MangaCatalog_1.MangaCatalog {
    constructor() {
        super(...arguments);
        this.baseUrl = DOMAIN;
        this.iconUrl = 'https://i.imgur.com/hCbdZKu.png';
        this.baseSourceList = [
            {
...
exports.ReadKingdom = ReadKingdom;
