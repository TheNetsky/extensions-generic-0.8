...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.ReadNarutoBoruto = exports.ReadNarutoBorutoInfo = void 0;
const types_1 = require("@paperback/types");
const MangaCatalog_1 = require("../MangaCatalog");
const DOMAIN = 'https://readnaruto.com';
exports.ReadNarutoBorutoInfo = {
...
class ReadNarutoBoruto extends MangaCatalog_1.MangaCatalog {
    constructor() {
        super(...arguments);
        this.baseUrl = DOMAIN;
        this.iconUrl = 'https://i.imgur.com/KY6yui9.png';
        this.baseSourceList = [
            {
...
exports.ReadNarutoBoruto = ReadNarutoBoruto;
