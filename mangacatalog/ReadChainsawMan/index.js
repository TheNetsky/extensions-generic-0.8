...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.ReadChainsawMan = exports.ReadChainsawManInfo = void 0;
const types_1 = require("@paperback/types");
const MangaCatalog_1 = require("../MangaCatalog");
const DOMAIN = 'https://readchainsawman.com';
exports.ReadChainsawManInfo = {
...
class ReadChainsawMan extends MangaCatalog_1.MangaCatalog {
    constructor() {
        super(...arguments);
        this.baseUrl = DOMAIN;
        this.iconUrl = 'https://i.imgur.com/EOwoyN9.png';
        this.baseSourceList = [
            {
...
exports.ReadChainsawMan = ReadChainsawMan;
