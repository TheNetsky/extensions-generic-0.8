...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.ReadDemonSlayer = exports.ReadDemonSlayerInfo = void 0;
const types_1 = require("@paperback/types");
const MangaCatalog_1 = require("../MangaCatalog");
const DOMAIN = 'https://demonslayermanga.com';
exports.ReadDemonSlayerInfo = {
...
class ReadDemonSlayer extends MangaCatalog_1.MangaCatalog {
    constructor() {
        super(...arguments);
        this.baseUrl = DOMAIN;
        this.iconUrl = 'https://i.imgur.com/aPt6kZ1.jpg';
        this.baseSourceList = [
            {
...
exports.ReadDemonSlayer = ReadDemonSlayer;
