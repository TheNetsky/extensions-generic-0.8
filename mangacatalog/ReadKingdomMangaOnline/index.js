...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.ReadKingdomMangaOnline = exports.ReadKingdomMangaOnlineInfo = void 0;
const types_1 = require("@paperback/types");
const MangaCatalog_1 = require("../MangaCatalog");
const DOMAIN = 'https://ww3.readkingdom.com';
exports.ReadKingdomMangaOnlineInfo = {
    version: (0, MangaCatalog_1.getExportVersion)('0.0.0'),
    name: 'ReadKingdomMangaOnline',
...
class ReadKingdomMangaOnline extends MangaCatalog_1.MangaCatalog {
    constructor() {
        super(...arguments);
        this.baseUrl = DOMAIN;
        this.sourceUrlList = [
            DOMAIN + "/manga/kingdom/",
            DOMAIN + "/manga/li-mu/",
            DOMAIN + "/manga/meng-wu-and-chu-zi-one-shot/",
        ];
    }
}
exports.ReadKingdomMangaOnline = ReadKingdomMangaOnline;
