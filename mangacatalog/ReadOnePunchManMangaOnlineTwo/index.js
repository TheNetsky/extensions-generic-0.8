...
const MangaCatalogUtil_1 = require("./MangaCatalogUtil");
...
class MangaCatalog {
    ...
    async getMangaDetails(mangaId) {
        ...
        return (0, MangaCatalogParser_1.parseMangaDetails)($, mangaId, this.mangaImageSelector, this.mangaTitleSelector, this.mangaDescriptionSelector);
    }
    async getChapters(mangaId) {
        ...
        const response = await this.requestManager.schedule(request, 1);
        const $ = this.cheerio.load(response.data);
        return (0, MangaCatalogParser_1.parseChapters)($, mangaId, this.chaptersArraySelector, this.chapterTitleSelector, this.chapterIdSelector, this.chapterDateSelector);
    }
    async getChapterDetails(mangaId, chapterId) {
        ...
        const response = await this.requestManager.schedule(request, 1);
        const $ = this.cheerio.load(response.data);
        return (0, MangaCatalogParser_1.parseChapterDetails)($, mangaId, chapterId, this.chapterImagesArraySelector, this.chapterImageSelector);
    }
    ...
    async populateMangas() {
        if (this.mangas.length == this.sourceUrlList.length)
            return;
        this.mangas = [];
        for (const sourceUrl of this.sourceUrlList) {
            ...
            const response = await this.requestManager.schedule(request, 1);
            const $ = this.cheerio.load(response.data);
            const title = (0, MangaCatalogUtil_1.decodeHTMLEntity)($(this.mangaTitleSelector).text().trim());
            const image = $(this.mangaImageSelector).attr('src') ?? "";
            const id = sourceUrl.split('/')[4] ?? "";
            if (!(!title || !image || !id)) {
...
},{"./MangaCatalogParser":71,"./MangaCatalogUtil":72,"@paperback/types":61}],71:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.parseChapterDetails = exports.parseChapters = exports.parseMangaDetails = void 0;
const MangaCatalogUtil_1 = require("./MangaCatalogUtil");
const parseMangaDetails = ($, mangaId, mangaImageSelector, mangaTitleSelector, mangaDescriptionSelector) => {
    const image = $(mangaImageSelector).attr('src') ?? "";
    const title = (0, MangaCatalogUtil_1.decodeHTMLEntity)($(mangaTitleSelector).text().trim());
    const description = (0, MangaCatalogUtil_1.decodeHTMLEntity)($(mangaDescriptionSelector).text().trim());
...
const parseChapters = ($, mangaId, chaptersArraySelector, chapterTitleSelector, chapterIdSelector, chapterDateSelector) => {
    const chapters = [];
    for (const chapter of $(chaptersArraySelector).toArray()) {
        const title = $(chapterTitleSelector, chapter).text();
        const chapterId = $(chapterIdSelector, chapter).attr('href').split('/')[4];
...
const parseChapterDetails = ($, mangaId, chapterId, chapterImagesArraySelector, chapterImageSelector) => {
    const pages = [];
...
},{"./MangaCatalogUtil":72}],72:[function(require,module,exports){
"use strict";
var __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.decodeHTMLEntity = void 0;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.ReadOnePunchManMangaOnlineTwo = exports.ReadOnePunchManMangaOnlineTwoInfo = void 0;
const types_1 = require("@paperback/types");
const MangaCatalog_1 = require("../MangaCatalog");
const DOMAIN = 'https://ww3.readopm.com';
exports.ReadOnePunchManMangaOnlineTwoInfo = {
...
class ReadOnePunchManMangaOnlineTwo extends MangaCatalog_1.MangaCatalog {
    constructor() {
        super(...arguments);
        this.baseUrl = DOMAIN;
        ...
        this.chapterTitleSelector = "td:nth-child(1)";
        this.chapterDateSelector = "td:nth-child(2)";
        this.chapterImagesArraySelector = "div.img_container.mb-2";
        this.chapterImageSelector = "img.pages__img";
        this.sourceUrlList = [
...
exports.ReadOnePunchManMangaOnlineTwo = ReadOnePunchManMangaOnlineTwo;

},{"../MangaCatalog":70,"@paperback/types":61}]},{},[73])(73)
});
