...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.ReadTokyoGhoul = exports.ReadTokyoGhoulInfo = void 0;
const types_1 = require("@paperback/types");
const MangaCatalog_1 = require("../MangaCatalog");
const DOMAIN = 'https://tokyoghoulre.com';
exports.ReadTokyoGhoulInfo = {
...
class ReadTokyoGhoul extends MangaCatalog_1.MangaCatalog {
    constructor() {
        super(...arguments);
        this.baseUrl = DOMAIN;
        this.iconUrl = 'https://i.imgur.com/LGjBype.png';
        this.baseSourceList = [
            {
...
exports.ReadTokyoGhoul = ReadTokyoGhoul;
