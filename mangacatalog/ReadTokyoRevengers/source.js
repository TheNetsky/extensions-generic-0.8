...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.ReadTokyoRevengers = exports.ReadTokyoRevengersInfo = void 0;
const types_1 = require("@paperback/types");
const MangaCatalog_1 = require("../MangaCatalog");
const DOMAIN = 'https://readtokyorevengers.net';
exports.ReadTokyoRevengersInfo = {
...
class ReadTokyoRevengers extends MangaCatalog_1.MangaCatalog {
    constructor() {
        super(...arguments);
        this.baseUrl = DOMAIN;
        this.iconUrl = 'https://i.imgur.com/Gwpyjgi.jpeg';
        this.baseSourceList = [
            {
...
exports.ReadTokyoRevengers = ReadTokyoRevengers;
