...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.ReadSoloLeveling = exports.ReadSoloLevelingInfo = void 0;
const types_1 = require("@paperback/types");
const MangaCatalog_1 = require("../MangaCatalog");
const DOMAIN = 'https://readsololeveling.org';
exports.ReadSoloLevelingInfo = {
...
class ReadSoloLeveling extends MangaCatalog_1.MangaCatalog {
    constructor() {
        super(...arguments);
        this.baseUrl = DOMAIN;
        this.iconUrl = 'https://i.imgur.com/leTtc1A.jpg';
        this.baseSourceList = [
            {
...
exports.ReadSoloLeveling = ReadSoloLeveling;
