...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.ReadMyHeroAcademia = exports.ReadMyHeroAcademiaInfo = void 0;
const types_1 = require("@paperback/types");
const MangaCatalog_1 = require("../MangaCatalog");
const DOMAIN = 'https://readmha.com';
exports.ReadMyHeroAcademiaInfo = {
...
class ReadMyHeroAcademia extends MangaCatalog_1.MangaCatalog {
    constructor() {
        super(...arguments);
        this.baseUrl = DOMAIN;
        this.iconUrl = 'https://i.imgur.com/c1rNiei.png';
        this.baseSourceList = [
            {
...
exports.ReadMyHeroAcademia = ReadMyHeroAcademia;
