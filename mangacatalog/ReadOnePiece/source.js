...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.ReadOnePiece = exports.ReadOnePieceInfo = void 0;
const types_1 = require("@paperback/types");
const MangaCatalog_1 = require("../MangaCatalog");
const DOMAIN = 'https://readonepiece.com';
exports.ReadOnePieceInfo = {
...
class ReadOnePiece extends MangaCatalog_1.MangaCatalog {
    constructor() {
        super(...arguments);
        this.baseUrl = DOMAIN;
        this.iconUrl = 'https://i.imgur.com/NKmkkq1.png';
        this.baseSourceList = [
            {
...
exports.ReadOnePiece = ReadOnePiece;
