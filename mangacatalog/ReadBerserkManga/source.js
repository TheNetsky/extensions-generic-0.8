...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.ReadBerserkManga = exports.ReadBerserkMangaInfo = void 0;
const types_1 = require("@paperback/types");
const MangaCatalog_1 = require("../MangaCatalog");
const DOMAIN = 'https://readberserk.com';
exports.ReadBerserkMangaInfo = {
...
class ReadBerserkManga extends MangaCatalog_1.MangaCatalog {
    constructor() {
        super(...arguments);
        this.baseUrl = DOMAIN;
...
exports.ReadBerserkManga = ReadBerserkManga;
