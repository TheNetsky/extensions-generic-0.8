...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.ReadHunterxHunter = exports.ReadHunterxHunterInfo = void 0;
const types_1 = require("@paperback/types");
const MangaCatalog_1 = require("../MangaCatalog");
const DOMAIN = 'https://readhxh.com';
exports.ReadHunterxHunterInfo = {
...
class ReadHunterxHunter extends MangaCatalog_1.MangaCatalog {
    constructor() {
        super(...arguments);
        this.baseUrl = DOMAIN;
        this.iconUrl = 'https://i.imgur.com/IJGrbuU.jpg';
        this.baseSourceList = [
            {
...
exports.ReadHunterxHunter = ReadHunterxHunter;
