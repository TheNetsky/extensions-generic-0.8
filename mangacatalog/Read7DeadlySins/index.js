...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.Read7DeadlySins = exports.Read7DeadlySinsInfo = void 0;
const types_1 = require("@paperback/types");
const MangaCatalog_1 = require("../MangaCatalog");
const DOMAIN = 'https://read7deadlysins.com';
exports.Read7DeadlySinsInfo = {
...
class Read7DeadlySins extends MangaCatalog_1.MangaCatalog {
    constructor() {
        super(...arguments);
        this.baseUrl = DOMAIN;
        this.iconUrl = 'https://i.imgur.com/kgIqH74.png';
        this.baseSourceList = [
            {
...
exports.Read7DeadlySins = Read7DeadlySins;
