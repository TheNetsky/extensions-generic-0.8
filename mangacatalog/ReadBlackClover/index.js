...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.ReadBlackClover = exports.ReadBlackCloverInfo = void 0;
const types_1 = require("@paperback/types");
const MangaCatalog_1 = require("../MangaCatalog");
const DOMAIN = 'https://readblackclover.com';
exports.ReadBlackCloverInfo = {
...
class ReadBlackClover extends MangaCatalog_1.MangaCatalog {
    constructor() {
        super(...arguments);
        this.baseUrl = DOMAIN;
        this.iconUrl = 'https://i.imgur.com/pKG50Z8.png';
        this.baseSourceList = [
            {
...
exports.ReadBlackClover = ReadBlackClover;
