...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.ReadKagurabachi = exports.ReadKagurabachiInfo = void 0;
const types_1 = require("@paperback/types");
const MangaCatalog_1 = require("../MangaCatalog");
const DOMAIN = 'https://readkagurabachimanga.com';
exports.ReadKagurabachiInfo = {
...
class ReadKagurabachi extends MangaCatalog_1.MangaCatalog {
    constructor() {
        super(...arguments);
        this.baseUrl = DOMAIN;
        this.iconUrl = 'https://i.imgur.com/N5ZF28b.png';
        this.baseSourceList = [
            {
...
exports.ReadKagurabachi = ReadKagurabachi;
