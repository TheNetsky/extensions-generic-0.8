...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.ReadBlueLock = exports.ReadBlueLockInfo = void 0;
const types_1 = require("@paperback/types");
const MangaCatalog_1 = require("../MangaCatalog");
const DOMAIN = 'https://bluelockread.com';
exports.ReadBlueLockInfo = {
...
class ReadBlueLock extends MangaCatalog_1.MangaCatalog {
    constructor() {
        super(...arguments);
        this.baseUrl = DOMAIN;
        this.iconUrl = 'https://i.imgur.com/yv8QOj4.png';
        this.baseSourceList = [
            {
...
exports.ReadBlueLock = ReadBlueLock;
