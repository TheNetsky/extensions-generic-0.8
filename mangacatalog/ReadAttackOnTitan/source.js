...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.ReadAttackOnTitan = exports.ReadAttackOnTitanInfo = void 0;
const types_1 = require("@paperback/types");
const MangaCatalog_1 = require("../MangaCatalog");
const DOMAIN = 'https://readsnk.com';
exports.ReadAttackOnTitanInfo = {
...
class ReadAttackOnTitan extends MangaCatalog_1.MangaCatalog {
    constructor() {
        super(...arguments);
        this.baseUrl = DOMAIN;
        this.iconUrl = 'https://i.imgur.com/XDcjemc.png';
        this.baseSourceList = [
            {
...
exports.ReadAttackOnTitan = ReadAttackOnTitan;
