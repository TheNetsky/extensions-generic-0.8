...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.ReadKaguyaSama = exports.ReadKaguyaSamaInfo = void 0;
const types_1 = require("@paperback/types");
const MangaCatalog_1 = require("../MangaCatalog");
const DOMAIN = 'https://readkaguyasama.com';
exports.ReadKaguyaSamaInfo = {
...
class ReadKaguyaSama extends MangaCatalog_1.MangaCatalog {
    constructor() {
        super(...arguments);
        this.baseUrl = DOMAIN;
        this.iconUrl = 'https://i.imgur.com/0CY4QGe.png';
        this.baseSourceList = [
            {
...
exports.ReadKaguyaSama = ReadKaguyaSama;
