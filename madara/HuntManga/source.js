...
var _Sources = (() => {
  ...
  // src/HuntManga/HuntManga.ts
  var HuntManga_exports = {};
  __export(HuntManga_exports, {
    HuntManga: () => HuntManga,
    HuntMangaInfo: () => HuntMangaInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/HuntManga/HuntManga.ts
  var DOMAIN = "https://huntmanga.com";
  var HuntMangaInfo = {
  ...
  var HuntManga = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(HuntManga_exports);
})();
