...
var _Sources = (() => {
  ...
  // src/ManhuaFast/ManhuaFast.ts
  var ManhuaFast_exports = {};
  __export(ManhuaFast_exports, {
    ManhuaFast: () => ManhuaFast,
    ManhuaFastInfo: () => ManhuaFastInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/ManhuaFast/ManhuaFast.ts
  var DOMAIN = "https://manhuafast.com";
  var ManhuaFastInfo = {
  ...
  var ManhuaFast = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(ManhuaFast_exports);
})();
