...
var _Sources = (() => {
  ...
  // src/DragonTea/DragonTea.ts
  var DragonTea_exports = {};
  __export(DragonTea_exports, {
    DragonTea: () => DragonTea,
    DragonTeaInfo: () => DragonTeaInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/DragonTea/DragonTea.ts
  var DOMAIN = "https://dragontea.ink";
  var DragonTeaInfo = {
  ...
  var DragonTea = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(DragonTea_exports);
})();
