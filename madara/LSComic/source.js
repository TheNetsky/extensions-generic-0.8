...
var _Sources = (() => {
  ...
  // src/LSComic/LSComic.ts
  var LSComic_exports = {};
  __export(LSComic_exports, {
    LSComic: () => LSComic,
    LSComicInfo: () => LSComicInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  var LSComic = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(LSComic_exports);
})();
