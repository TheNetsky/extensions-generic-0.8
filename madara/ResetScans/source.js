...
var _Sources = (() => {
  ...
  var ResetScans_exports = {};
  __export(ResetScans_exports, {
    ResetScans: () => ResetScans,
    ResetScansInfo: () => ResetScansInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/ResetScans/ResetScans.ts
  var DOMAIN = "https://rspro.xyz/home";
  var ResetScansInfo = {
  ...
  var ResetScans = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(ResetScans_exports);
})();
