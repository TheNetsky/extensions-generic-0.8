...
var _Sources = (() => {
  ...
  // src/Manga3asq/Manga3asq.ts
  var Manga3asq_exports = {};
  __export(Manga3asq_exports, {
    Manga3asq: () => Manga3asq,
    Manga3asqInfo: () => Manga3asqInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/Manga3asq/Manga3asqParser.ts
  var Manga3asqParser = class extends Parser3 {
    constructor() {
      super(...arguments);
      this.parseDate = (date) => {
        date = date.toUpperCase();
        ...
        if (date.includes("\u0642\u0628\u0644 \u0633\u0627\u0639\u0629") || date.includes("\u0627\u0644\u0627\u0646") || date.includes("\u0623\u0644\u0627\u0646")) {
          ...
          time = new Date(Date.now() - 2 * 6048e5);
        } else if (date.includes("\u064A\u0648\u0645\u064A\u0646")) {
          time = new Date(Date.now() - 2 * 864e5);
        } else if (date.includes("\u064A\u0648\u0645 \u0648\u0627\u062D\u062F") || date.includes("\u064A\u0648\u0645 \u0648\u0623\u062D\u062F")) {
          time = new Date(Date.now() - 1 * 864e5);
  ...
  var Manga3asq = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
      this.language = "\u{1F1E6}\u{1F1EA}";
      this.chapterEndpoint = 1;
      this.parser = new Manga3asqParser();
    }
  };
  return __toCommonJS(Manga3asq_exports);
})();
