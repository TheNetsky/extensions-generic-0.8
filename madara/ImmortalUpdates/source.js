...
var _Sources = (() => {
  ...
  // src/ImmortalUpdates/ImmortalUpdates.ts
  var ImmortalUpdates_exports = {};
  __export(ImmortalUpdates_exports, {
    ImmortalUpdates: () => ImmortalUpdates,
    ImmortalUpdatesInfo: () => ImmortalUpdatesInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/ImmortalUpdates/ImmortalUpdates.ts
  var DOMAIN = "https://mortalsgroove.com";
  var ImmortalUpdatesInfo = {
  ...
  var ImmortalUpdates = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(ImmortalUpdates_exports);
})();
