...
var _Sources = (() => {
  ...
  // src/Manhuaga/Manhuaga.ts
  var Manhuaga_exports = {};
  __export(Manhuaga_exports, {
    Manhuaga: () => Manhuaga,
    ManhuagaInfo: () => ManhuagaInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  var Manhuaga = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(Manhuaga_exports);
})();
