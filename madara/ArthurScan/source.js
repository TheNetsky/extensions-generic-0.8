...
var _Sources = (() => {
  ...
  // src/ArthurScan/ArthurScan.ts
  var ArthurScan_exports = {};
  __export(ArthurScan_exports, {
    ArthurScan: () => ArthurScan,
    ArthurScanInfo: () => ArthurScanInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/ArthurScan/ArthurScan.ts
  var DOMAIN = "https://arthurscan.xyz";
  var ArthurScanInfo = {
  ...
  var ArthurScan = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
      this.language = "\u{1F1F5}\u{1F1F9}";
      this.chapterEndpoint = 1;
    }
  };
  return __toCommonJS(ArthurScan_exports);
})();
