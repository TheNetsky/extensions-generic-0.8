...
var _Sources = (() => {
  ...
  // src/DarkScans/DarkScans.ts
  var DarkScans_exports = {};
  __export(DarkScans_exports, {
    DarkScans: () => DarkScans,
    DarkScansInfo: () => DarkScansInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/DarkScans/DarkScans.ts
  var DOMAIN = "https://darkscans.net";
  var DarkScansInfo = {
  ...
  var DarkScans = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(DarkScans_exports);
})();
