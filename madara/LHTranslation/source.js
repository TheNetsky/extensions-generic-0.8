...
var _Sources = (() => {
  ...
  // src/LHTranslation/LHTranslation.ts
  var LHTranslation_exports = {};
  __export(LHTranslation_exports, {
    LHTranslation: () => LHTranslation,
    LHTranslationInfo: () => LHTranslationInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/LHTranslation/LHTranslation.ts
  var DOMAIN = "https://lhtranslation.net";
  var LHTranslationInfo = {
  ...
  var LHTranslation = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(LHTranslation_exports);
})();
