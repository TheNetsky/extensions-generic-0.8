...
var _Sources = (() => {
  ...
  // src/NovelMic/NovelMic.ts
  var NovelMic_exports = {};
  __export(NovelMic_exports, {
    NovelMic: () => NovelMic,
    NovelMicInfo: () => NovelMicInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  var NovelMic = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
    }
  };
  return __toCommonJS(NovelMic_exports);
})();
