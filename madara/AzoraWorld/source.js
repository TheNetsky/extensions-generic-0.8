...
var _Sources = (() => {
  ...
  // src/AzoraWorld/AzoraWorld.ts
  var AzoraWorld_exports = {};
  __export(AzoraWorld_exports, {
    AzoraWorld: () => AzoraWorld,
    AzoraWorldInfo: () => AzoraWorldInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/AzoraWorld/AzoraWorldParser.ts
  var AzoraWorldParser = class extends Parser3 {
    constructor() {
      super(...arguments);
      this.parseDate = (date) => {
        date = date.toUpperCase();
        ...
        if (date.includes("\u0642\u0628\u0644 \u0633\u0627\u0639\u0629") || date.includes("\u0627\u0644\u0627\u0646")) {
          ...
          time = new Date(Date.now() - (number + 2 * 864e5));
  ...
  var AzoraWorld = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
      ...
      this.parser = new AzoraWorldParser();
    }
    async getHomePageSections(sectionCallback) {
      const sections = [
        {
  ...
  return __toCommonJS(AzoraWorld_exports);
})();
