...
var _Sources = (() => {
  ...
  // src/MangaReadOrg/MangaReadOrg.ts
  var MangaReadOrg_exports = {};
  __export(MangaReadOrg_exports, {
    MangaReadOrg: () => MangaReadOrg,
    MangaReadOrgInfo: () => MangaReadOrgInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/MangaReadOrg/MangaReadOrgParser.ts
  var MangaReadOrgParser = class extends Parser3 {
    constructor() {
      super(...arguments);
      this.parseDate = (date) => {
        date = date.toUpperCase();
  ...
  // src/MangaReadOrg/MangaReadOrg.ts
  var DOMAIN = "https://www.mangaread.org";
  var MangaReadOrgInfo = {
  ...
  var MangaReadOrg = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
      this.chapterEndpoint = 1;
      this.parser = new MangaReadOrgParser();
    }
  };
  return __toCommonJS(MangaReadOrg_exports);
})();
