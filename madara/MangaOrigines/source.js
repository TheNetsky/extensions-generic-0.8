...
var _Sources = (() => {
  ...
  var MangaOrigines_exports = {};
  __export(MangaOrigines_exports, {
    MangaOrigines: () => MangaOrigines,
    MangaOriginesInfo: () => MangaOriginesInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  var MangaOrigines = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(MangaOrigines_exports);
})();
