...
var _Sources = (() => {
  ...
  // src/SetsuScans/SetsuScans.ts
  var SetsuScans_exports = {};
  __export(SetsuScans_exports, {
    SetsuScans: () => SetsuScans,
    SetsuScansInfo: () => SetsuScansInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/SetsuScans/SetsuScans.ts
  var DOMAIN = "https://setsuscans.com";
  var SetsuScansInfo = {
  ...
  var SetsuScans = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(SetsuScans_exports);
})();
