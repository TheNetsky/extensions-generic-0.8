...
var _Sources = (() => {
  ...
  // src/ManhuaSY/ManhuaSY.ts
  var ManhuaSY_exports = {};
  __export(ManhuaSY_exports, {
    ManhuaSY: () => ManhuaSY,
    ManhuaSYInfo: () => ManhuaSYInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  var ManhuaSY = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(ManhuaSY_exports);
})();
