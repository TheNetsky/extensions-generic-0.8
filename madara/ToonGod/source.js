...
var _Sources = (() => {
  ...
  // src/ToonGod/ToonGod.ts
  var ToonGod_exports = {};
  __export(ToonGod_exports, {
    ToonGod: () => ToonGod,
    ToonGodInfo: () => ToonGodInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/ToonGod/ToonGod.ts
  var DOMAIN = "https://www.toongod.org";
  var ToonGodInfo = {
  ...
  var ToonGod = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
      this.directoryPath = "webtoons";
  ...
  return __toCommonJS(ToonGod_exports);
})();
