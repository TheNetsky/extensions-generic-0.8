...
var _Sources = (() => {
  ...
  // src/KunManga/KunManga.ts
  var KunManga_exports = {};
  __export(KunManga_exports, {
    KunManga: () => KunManga,
    KunMangaInfo: () => KunMangaInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  var KunManga = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(KunManga_exports);
})();
