...
var _Sources = (() => {
  ...
  // src/TheBlank/TheBlank.ts
  var TheBlank_exports = {};
  __export(TheBlank_exports, {
    TheBlank: () => TheBlank,
    TheBlankInfo: () => TheBlankInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  var TheBlank = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
      this.chapterEndpoint = 1;
      this.bypassPage = `${DOMAIN}/manga/`;
    }
  };
  return __toCommonJS(TheBlank_exports);
})();
