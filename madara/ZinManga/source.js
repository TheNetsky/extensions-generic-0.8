...
var _Sources = (() => {
  ...
  // src/ZinManga/ZinManga.ts
  var ZinManga_exports = {};
  __export(ZinManga_exports, {
    ZinManga: () => ZinManga,
    ZinMangaInfo: () => ZinMangaInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  var ZinManga = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(ZinManga_exports);
})();
