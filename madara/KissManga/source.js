...
var _Sources = (() => {
  ...
  // src/KissManga/KissManga.ts
  var KissManga_exports = {};
  __export(KissManga_exports, {
    KissManga: () => KissManga,
    KissMangaInfo: () => KissMangaInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/KissManga/KissManga.ts
  var DOMAIN = "https://1st-kissmanga.net";
  var KissMangaInfo = {
  ...
  var KissManga = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(KissManga_exports);
})();
