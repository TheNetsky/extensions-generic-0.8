...
var _Sources = (() => {
  ...
  // src/ManhwaRaw/ManhwaRaw.ts
  var ManhwaRaw_exports = {};
  __export(ManhwaRaw_exports, {
    ManhwaRaw: () => ManhwaRaw,
    ManhwaRawInfo: () => ManhwaRawInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/ManhwaRaw/ManhwaRaw.ts
  var DOMAIN = "https://manhwa-raw.com";
  var ManhwaRawInfo = {
  ...
  var ManhwaRaw = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
      this.chapterEndpoint = 3;
      this.language = "\u{1F1F0}\u{1F1F7}";
      this.hasAdvancedSearchPage = false;
    }
  };
  return __toCommonJS(ManhwaRaw_exports);
})();
