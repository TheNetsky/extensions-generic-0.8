...
var _Sources = (() => {
  ...
  // src/ManhwaFull/ManhwaFull.ts
  var ManhwaFull_exports = {};
  __export(ManhwaFull_exports, {
    ManhwaFull: () => ManhwaFull,
    ManhwaFullInfo: () => ManhwaFullInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/ManhwaFull/ManhwaFull.ts
  var DOMAIN = "https://manhwafull.com";
  var ManhwaFullInfo = {
  ...
  var ManhwaFull = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(ManhwaFull_exports);
})();
