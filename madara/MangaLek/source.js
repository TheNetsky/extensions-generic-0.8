...
var _Sources = (() => {
  ...
  var MangaLek_exports = {};
  __export(MangaLek_exports, {
    MangaLek: () => MangaLek,
    MangaLekInfo: () => MangaLekInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/MangaLek/MangaLekParser.ts
  var MangaLekParser = class extends Parser3 {
    constructor() {
      super(...arguments);
      this.parseDate = (date) => {
        date = date.toUpperCase();
  ...
  // src/MangaLek/MangaLek.ts
  var DOMAIN = "https://lek-manga.net";
  var MangaLekInfo = {
  ...
  var MangaLek = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
      ...
      this.parser = new MangaLekParser();
    }
  };
  return __toCommonJS(MangaLek_exports);
})();
