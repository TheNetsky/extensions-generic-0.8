...
var _Sources = (() => {
  ...
  // src/RDScans/RDScans.ts
  var RDScans_exports = {};
  __export(RDScans_exports, {
    RDScans: () => RDScans,
    RDScansInfo: () => RDScansInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  var RDScans = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
      this.chapterEndpoint = 1;
      this.chapterDetailsSelector = "div.text-left img";
    }
  };
  return __toCommonJS(RDScans_exports);
})();
