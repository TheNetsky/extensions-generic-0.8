...
var _Sources = (() => {
  ...
  // src/MangaScantrad/MangaScantrad.ts
  var MangaScantrad_exports = {};
  __export(MangaScantrad_exports, {
    MangaScantrad: () => MangaScantrad,
    MangaScantradInfo: () => MangaScantradInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/MangaScantrad/MangaScantrad.ts
  var DOMAIN = "https://manga-scantrad.io";
  var MangaScantradInfo = {
  ...
  var MangaScantrad = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(MangaScantrad_exports);
})();
