...
var _Sources = (() => {
  ...
  // src/LilyManga/LilyManga.ts
  var LilyManga_exports = {};
  __export(LilyManga_exports, {
    LilyManga: () => LilyManga,
    LilyMangaInfo: () => LilyMangaInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/LilyManga/LilyManga.ts
  var DOMAIN = "https://lilymanga.net";
  var LilyMangaInfo = {
  ...
  var LilyManga = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(LilyManga_exports);
})();
