...
var _Sources = (() => {
  ...
  var WebtoonXYZ_exports = {};
  __export(WebtoonXYZ_exports, {
    WebtoonXYZ: () => WebtoonXYZ,
    WebtoonXYZInfo: () => WebtoonXYZInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  var WebtoonXYZ = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(WebtoonXYZ_exports);
})();
