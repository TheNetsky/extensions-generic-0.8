...
var _Sources = (() => {
  ...
  // src/AstralLibrary/AstralLibrary.ts
  var AstralLibrary_exports = {};
  __export(AstralLibrary_exports, {
    AstralLibrary: () => AstralLibrary,
    AstralLibraryInfo: () => AstralLibraryInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/AstralLibrary/AstralLibrary.ts
  var DOMAIN = "https://astrallibrary.net";
  var AstralLibraryInfo = {
  ...
  var AstralLibrary = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(AstralLibrary_exports);
})();
