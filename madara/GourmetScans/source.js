...
var _Sources = (() => {
  ...
  // src/GourmetScans/GourmetScans.ts
  var GourmetScans_exports = {};
  __export(GourmetScans_exports, {
    GourmetScans: () => GourmetScans,
    GourmetScansInfo: () => GourmetScansInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/GourmetScans/GourmetScans.ts
  var DOMAIN = "https://gourmetsupremacy.com";
  var GourmetScansInfo = {
  ...
  var GourmetScans = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(GourmetScans_exports);
})();
