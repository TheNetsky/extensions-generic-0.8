...
var _Sources = (() => {
  ...
  // src/MangaClash/MangaClash.ts
  var MangaClash_exports = {};
  __export(MangaClash_exports, {
    MangaClash: () => MangaClash,
    MangaClashInfo: () => MangaClashInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/MangaClash/MangaClash.ts
  var DOMAIN = "https://toonclash.com";
  var MangaClashInfo = {
  ...
  var MangaClash = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(MangaClash_exports);
})();
