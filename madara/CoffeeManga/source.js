...
var _Sources = (() => {
  ...
  var CoffeeManga_exports = {};
  __export(CoffeeManga_exports, {
    CoffeeManga: () => CoffeeManga,
    CoffeeMangaInfo: () => CoffeeMangaInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  var CoffeeManga = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(CoffeeManga_exports);
})();
