...
var _Sources = (() => {
  ...
  // src/AllPornComic/AllPornComic.ts
  var AllPornComic_exports = {};
  __export(AllPornComic_exports, {
    AllPornComic: () => AllPornComic,
    AllPornComicInfo: () => AllPornComicInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/AllPornComic/AllPornComic.ts
  var DOMAIN = "https://allporncomic.com";
  var AllPornComicInfo = {
  ...
  var AllPornComic = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(AllPornComic_exports);
})();
