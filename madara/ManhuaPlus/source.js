...
var _Sources = (() => {
  ...
  // src/ManhuaPlus/ManhuaPlus.ts
  var ManhuaPlus_exports = {};
  __export(ManhuaPlus_exports, {
    ManhuaPlus: () => ManhuaPlus,
    ManhuaPlusInfo: () => ManhuaPlusInfo
  });
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  // src/ManhuaPlus/ManhuaPlus.ts
  var DOMAIN = "https://manhuaplus.com";
  var ManhuaPlusInfo = {
  ...
  var ManhuaPlus = class extends Madara {
    constructor() {
      super(...arguments);
      this.baseUrl = DOMAIN;
  ...
  return __toCommonJS(ManhuaPlus_exports);
})();
